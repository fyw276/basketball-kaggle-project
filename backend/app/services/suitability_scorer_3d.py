...
SCENE_SCORE_RULES: Dict[str, Dict[str, int]] = {
    ...
    "冷白": {
        "高分": ["蓝色", "紫色", "粉色", "灰色", "黑色", "粉", "紫", "藏青", "银", "亮灰"],
        "中分": ["绿色", "白色", "红色", "绿", "白", "红", "青"],
        "低分": ["橙色", "黄色", "棕色", "橙", "黄", "棕", "米", "卡其"],
    },
    # 黄皮 — 推荐蓝色/绿色/白色/灰色
    "黄皮": {
        "高分": ["蓝色", "绿色", "白色", "灰色", "蓝", "绿", "白", "灰", "青", "墨绿"],
        "中分": ["紫色", "粉色", "黑色", "紫", "粉", "黑", "藏青"],
        "低分": ["黄色", "橙色", "棕色", "黄", "橙", "棕", "米", "卡其", "酒红"],
    },
    # 小麦肤色 — 推荐白色/蓝色/绿色/红色
    "小麦": {
        "高分": ["白色", "蓝色", "绿色", "红色", "白", "蓝", "绿", "红", "粉", "橙"],
        "中分": ["黑色", "灰色", "紫色", "黑", "灰", "紫", "藏青"],
        "低分": ["黄色", "棕色", "黄", "棕", "米", "卡其", "暗红"],
    },
    # 深色肤色 — 推荐白色/红色/蓝色/黄色
    "深色": {
        "高分": ["白色", "红色", "蓝色", "黄色", "白", "红", "蓝", "黄", "粉", "橙", "金"],
        "中分": ["绿色", "紫色", "粉色", "绿", "紫", "青"],
        "低分": ["黑色", "棕色", "灰色", "黑", "棕", "灰", "深灰", "酒红"],
    },
}
