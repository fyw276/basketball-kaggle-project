...
SKIN_TONE_COLOR_RULES: Dict[str, Dict[str, List[str]]] = {
    "冷白": {
        "高分": ["蓝色", "紫色", "粉色", "灰色", "黑色", "粉", "紫", "藏青", "银", "亮灰", "青"],
        "中分": ["绿色", "白色", "红色", "绿", "白", "红", "墨绿"],
        "低分": ["橙色", "黄色", "棕色", "橙", "黄", "棕", "米", "卡其", "酒红"],
    },
    "黄皮": {
        "高分": ["蓝色", "绿色", "白色", "灰色", "蓝", "绿", "白", "灰", "青", "墨绿", "藏青"],
        "中分": ["紫色", "粉色", "黑色", "紫", "粉", "黑"],
        "低分": ["黄色", "橙色", "棕色", "黄", "橙", "棕", "米", "卡其", "酒红", "暗红"],
    },
    "小麦": {
        "高分": ["白色", "蓝色", "绿色", "红色", "白", "蓝", "绿", "红", "粉", "橙", "金"],
        "中分": ["黑色", "灰色", "紫色", "黑", "灰", "紫"],
        "低分": ["黄色", "棕色", "黄", "棕", "米", "卡其", "暗红", "酒红"],
    },
    "深色": {
        "高分": ["白色", "红色", "蓝色", "黄色", "白", "红", "蓝", "黄", "粉", "橙", "金", "亮灰"],
        "中分": ["绿色", "紫色", "粉色", "绿", "紫", "粉", "青", "墨绿"],
        "低分": ["黑色", "棕色", "灰色", "黑", "棕", "灰", "深灰", "酒红", "暗红"],
    },
}
