...
def _run_catvton_sync(
    *,
    ...
    try:
        ...
        # Build command
        # catvton_engine_client.py is at backend/app/services/tryon_v2/catvton_engine_client.py
        # backend_dir should be the backend/ root
        ...
        runner_paths = [
            project_root / "vton_inference_service" / "catvton_runner.py",
            backend_dir / "vton_inference_service" / "catvton_runner.py",
            backend_dir / "catvton_runner.py",
