...
class UserProfile(Base):
    ...
    style_preference = Column(JSONB, nullable=False)  # List of style preferences
    budget_range = Column(String(20), nullable=False)  # 经济/中等/高端
    avoid_body_parts = Column(JSONB, default=list)  # List of body parts to avoid emphasizing
