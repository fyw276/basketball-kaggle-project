...
assert (
    up_fields["gender_expression"].is_required() == False
), "gender_expression should be optional!"
...
assert (
    card_fields["gender_compatibility"].is_required() == False
), "gender_compatibility should be optional!"
