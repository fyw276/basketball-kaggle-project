...
**最后更新**: 2026-04-27
**项目版本**: v1.4.0
**状态**: ✅ 核心功能完成；CatVTON 本地深度学习引擎已集成，路径和日志问题已修复

---

## 🆕 本次更新（2026-04-27）

- ✅ **CatVTON 集成修复**：修复 runner 脚本路径计算错误，子进程工作目录错误
- ✅ **CatVTON 路径自动检测**：自动检测 `D:\models\CatVTON_full` 或 `D:\models\CatVTON`
- ✅ **请求日志中间件**：添加 `RequestLoggingMiddleware` 显示每个 API 请求
- ✅ **CatVTON 实时日志**：使用线程流式传输子进程输出到终端
- ✅ **白盒调试工具**：创建诊断脚本和调试中间产物保存
- ✅ **文档更新**：`CATVTON_INSTALL_GUIDE.md`、`TRYON_FIX_SUMMARY.md`、`README.md`
